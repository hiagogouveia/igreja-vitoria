...
const Beliefs = () => {
    ...
    return (
        <section ref={sectionRef} className="relative py-20 bg-dark-bg overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {beliefs.map((item, index) => (
                        <div key={index} ref={el => cardsRef.current[index] = el}>
                            <Card className="h-full flex flex-col items-center text-center hover:bg-white/10 transition-colors">
