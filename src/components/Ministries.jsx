...
const Ministries = () => {
    ...
    const ministries = [
        ...
        { id: 'operacionais', name: "Operacionais", icon: <Wrench />, color: "text-neon-purple", img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=1080&auto=format&fit=crop" }, // Volunteers/Teamwork
        ...
        { id: 'welcome', name: "Welcome", icon: <HeartHandshake />, color: "text-neon-purple", img: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?q=80&w=1080&auto=format&fit=crop" }, // Friends/Welcome
    ];
    ...
    useEffect(() => {
        ...
        // Parallax & Glow Effects for cards are handled by CSS hover, but entrance can be GSAP
        gsap.utils.toArray('.ministry-card').forEach((card, i) => {
            gsap.fromTo(card,
    ...
    return (
        <section ref={sectionRef} className="relative py-24 bg-black overflow-hidden" id="ministries">
            {/* Background Texture - Simulated Stage */}
