                        ...
                        <div key={i} className="bg-white/5 rounded-2xl p-8 border border-white/5 hover:border-neon-purple/50 transition-all duration-300 group">
                            <div className="flex flex-col items-center text-center">
                                <div className="relative mb-6">
                                    <div className="relative w-24 h-24 rounded-full overflow-hidden border-2 border-white/20 group-hover:border-neon-purple transition-all duration-300 grayscale group-hover:grayscale-0">
                                        <Image
                                            src={t.image}
                                            alt={t.name}
                                            fill
