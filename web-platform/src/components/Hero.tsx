...
const Hero = () => {
    ...
    return (
        <div ref={heroRef} className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-dark-bg" id="home">
            {/* Dynamic Background */}
                ...
                <div className="mb-8 flex justify-center">
                    <div className="relative h-32 w-32">
                        <Image
                            ...
                            alt="Logo V"
                            fill
                            className="object-contain invert drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] animate-pulse"
                            priority
                        />
                    </div>
                </div>
