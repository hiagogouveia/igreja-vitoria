...
export const fallbackEvents: SiteEvent[] = [
  ...
  { id: 'sister-2026', title: 'Sister · 6 anos', date: '26 SET', time: 'Sábado, 18h', place: 'Igreja Vitória', featured: true, badge: 'Inscrições encerradas', photo: '/assets/worship-arms.jpg', art: { bg: 'linear-gradient(165deg,#FAEDEA,#F2DBD6)', fg: '#C4676B', label: 'Sister', sub: '6 anos', serif: true }, desc: 'A noite das mulheres dentro da Conferência Céus Abertos, comemorando 6 anos. Com Ap. Rayssa Coelho, Ap. Maricleyde Cardoso e Ap. Neila Lopes. As inscrições estão encerradas.', href: '/ceus-abertos#sister', cta: 'Ver detalhes' },
